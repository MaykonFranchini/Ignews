...
export const getStaticProps:GetStaticProps = async ({ params }) => {
  ...
  const post = {
    ...
    updatedAt: new Date(response.last_publication_date).toLocaleDateString('en-UK', {
      day: '2-digit',
      month: 'long',
      year: 'numeric'
    }) 
  ...
  return {
    props: { post },
    redirect: 60 * 30, // revalidate the static page every 30 minutes
  }
